...
namespace HabitatManagement.Business
{
    public class FormDesignTemplateModelBE
    {
        ...
        private string HtmlFields(IGrouping<string, FormDesignTemplateDetailBE> groupingFields)
        {
            ...
            sb.AppendFormat("<div class=\"col-lg-12 col-form-label fontBold mb-2\" {0} >{1}</div>", !string.IsNullOrWhiteSpace(sortableGroupingFields[0].BackgroundColor) ? string.Format("style = 'background-color:{0};'", sortableGroupingFields[0].BackgroundColor) : "", sortableGroupingFields[0].SectionDescription);
