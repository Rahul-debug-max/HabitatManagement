...
(function ($, undefined) {
    ...
    var _idx = 0,
        ...
        transColor = '#0000ffff',
        hexToRGB = function (hex, alphaYes) {
            var c;
        ...
        rgbToHex = function (rgb) {
            ...
            else if (this.options.defaultColor) {
        ...
        rgbToHexWithDefault = function (rgb, deafultColor) {
    ...
    $.widget("evol.colorpicker", {
        ...
        options: {
            ...
            strings: 'Theme Colours,Standard Colours,Web Colours,Theme Colours,Back to Palette,History,No history yet.',
            defaultColor: "#fff",
            allowHexCode: false
        },
        ...
        _create: function () {
            ...
            switch (this.element.get(0).tagName) {
                case 'INPUT':
                    var color = this.options.color ? this.options.color : this.options.defaultColor,
                        e = this.element,
                        style = '';
                    this._isPopup = true;
                    ...
                    if (color !== null) {
                        ...
                        // if (color != v) e.val(hexToRGB(color)).change();
                        if (color != v) that._setValue(color, true);
                    } else {
                        if (v !== '') {
                    ...
                    var allowHEX = this.options.allowHexCode;
                    e.addClass('colorPicker ' + this._id)
                        .on('keyup onpaste change', function (evt) {
                            var c = '';
                            if (!allowHEX)
                                c = rgbToHexWithDefault($(this).val(), that.options.defaultColor);
                            else
                                c = $(this).val()
            ...
            while (el !== null && i < 100) {
                ...
                if (el.css('overflow') != 'visible') {
                    ...
                    if (openUp) {
                        ...
                        this._palette.css({ top: '33px', left: '0', width: '100%' });
                    }
                    break;
                }
        ...
        _setValue: function (c, noHide) {
            ...
            if (this._isPopup) {
                ...
                var rgbaValue = '';
                if (!this.options.allowHexCode)
                    rgbaValue = hexToRGB(c, true);
                else
                    rgbaValue = c;
                this._setBoxColor(this.element.val(rgbaValue).closest("div").find(".colorpicker-addon"), c);
            } else {
